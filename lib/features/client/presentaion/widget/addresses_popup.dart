        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search for an address',
                hintStyle: TextStyle(color: AppColors.tritiaryColor),
                prefixIcon: Icon(Icons.search, color: AppColors.tritiaryColor),
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(15.r),
                  borderSide: BorderSide(
                      color: AppColors.tritiaryColor), // Default border color
                ),
                enabledBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(15.r),
                  borderSide: BorderSide(
                      color: AppColors.tritiaryColor), // Unfocused border color
                ),
            ...
            Padding(
              ...
              child: ElevatedButton(
                style: ButtonStyle(
                  backgroundColor:
                      WidgetStateProperty.all(AppColors.tritiaryColor),
